...
internal class ShapeCollectorWithGenericsImplTest {

    private lateinit var shapeCollector: ShapeCollectorWithGenerics<ColoredShape2d>

    @BeforeEach
    fun setUp() {
        shapeCollector = ShapeCollectorWithGenericsImpl()
    }
    ...
    @Test
    fun addAllInEmptyShapeCollector() {
        val shape1 = ColoredCircle(5.0, ColorRGB(1, 2, 3, 4), ColorRGB(5, 6, 7, 8))
        val shape2 = ColoredRectangle(4.0, 5.0, ColorRGB(50, 50, 50, 50), ColorRGB(5, 6, 7, 8))
        val shape3 = ColoredSquare(4.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))
        val shape4 = ColoredSquare(4.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))

        shapeCollector.addAll(listOf(shape1, shape2, shape3, shape4))
        assertEquals(listOf(shape1, shape2, shape3, shape4), shapeCollector.getAllShapes())
    }

    @Test
    fun addAllInNotEmptyShapeCollector() {
        val shape1 = ColoredCircle(5.0, ColorRGB(1, 2, 3, 4), ColorRGB(5, 6, 7, 8))
        val shape2 = ColoredRectangle(4.0, 5.0, ColorRGB(50, 50, 50, 50), ColorRGB(5, 6, 7, 8))
        val shape3 = ColoredSquare(4.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))
        val shape4 = ColoredSquare(4.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))

        val shape5 = ColoredCircle(7.0, ColorRGB(1, 2, 3, 4), ColorRGB(5, 6, 7, 8))
        val shape6 = ColoredTriangle(4.0, 5.0, 6.0, ColorRGB(50, 50, 50, 50), ColorRGB(5, 6, 7, 8))
        val shape7 = ColoredSquare(5.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))
        ...
        shapeCollector.addAll(listOf(shape5, shape6, shape7))
        assertEquals(listOf(shape1, shape2, shape3, shape4, shape5, shape6, shape7), shapeCollector.getAllShapes())
    }

    @Test
    fun getSorted() {
        val shape1 = ColoredRectangle(4.0, 5.0, ColorRGB(50, 50, 50, 50), ColorRGB(5, 6, 7, 8))
        val shape2 = ColoredSquare(4.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))
        val shape3 = ColoredSquare(5.0, ColorRGB(100, 100, 100, 100), ColorRGB(9, 10, 11, 12))

        shapeCollector.addAll(listOf(shape1, shape2, shape3))

        assertEquals(listOf(shape2, shape1, shape3), shapeCollector.getSorted(compareBy { it.calcArea() }))
    }
